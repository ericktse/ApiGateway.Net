...
namespace WebProxy.Net.Route
{
    public class Demo
    {
        ...
        public string ClientRequest()
        {
            ...
            //命名名（必填）
            head.Command = "ControllerName.ActionName1";
            //版本号（选填）
            head.Version = "1.2.0";
            ...
            bodyDic.Add("Condition1", "1");
            bodyDic.Add("Condition2", "b");
        ...
        public void WebAPIReceive()
        {
            ...
            //if (headFrom != null)
            //{
            //    headFrom = Encoding.UTF8.GetString(EncryptHelper.Base64Decode(headFrom));
